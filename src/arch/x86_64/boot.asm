...
; from https://wiki.osdev.org/Setting_Up_Long_Mode#Detection_of_CPUID
check_cpuid:
...
; from https://wiki.osdev.org/Setting_Up_Long_Mode#x86_or_x86-64
check_long_mode:
...
; set up a 64 bit GDT with a read only code segment
section .rodata
gdt64:
    dq 0 ; zero entry
